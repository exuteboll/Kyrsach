    ...
    internal class DentalClinic
    {
       ...
       .Sum(payment => payment.Amount);
        ...
        public bool RemovePatient(int patientId)
        {
            ...
            // Проверяем, есть ли связанные записи (визиты или платежи)
            ...
            // Обновляем счётчик ID, если удалили пациента с максимальным ID
        ...
        public bool RemoveService(int serviceId)
        {
            ...
            // Проверяем, есть ли связанные записи (визиты)
            ...
            // Обновляем счётчик ID, если удалили услугу с максимальным ID
